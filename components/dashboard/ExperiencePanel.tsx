...
export default function ExperiencePanel() {
  return (
    <section id="experience" className="border border-card-border bg-card-bg rounded p-5 font-mono text-sm shadow-sm hover:shadow-md transition-all duration-300 flex flex-col justify-between h-[580px]">
